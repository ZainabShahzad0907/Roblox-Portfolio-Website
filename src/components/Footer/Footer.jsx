    ...
    <footer className="footer">
      ...
      <div className="footer-wrapper">
        ...
        <div className="footer-content">
          ...
          >
            <h3 className="brand-name">Your<span className="brand-highlight">Name</span></h3>
          ...
          >
            ...
            <div className="contact-info">
              <a href="mailto:zainabshaheen324@gmail.com" className="contact-item">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                  <polyline points="22,6 12,13 2,6"/>
                </svg>
                <span>zainabshaheen324@gmail.com</span>
              </a>
        ...
        >
          ...
          <div className="bottom-content">
            <p className="copyright">
              © {currentYear} <span className="copyright-name">YourName</span>. All rights reserved.
            </p>
            <p className="crafted">
